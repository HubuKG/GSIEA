...
class cfg():
    ...
    def get_args(self):
        ...
        parser.add_argument("--model_name", default="GSIEA", type=str, choices=["EVA", "MCLEA", "MSNEA", "GSIEA"], help="model name")
        ...
        parser.add_argument("--hidden_units", type=str, default="100,100,100", help="hidden units in each hidden layer(including in_dim and out_dim), splitted with comma")
        ...
        # --------- GSIEA -----------
        parser.add_argument("--hidden_size", type=int, default=100, help="the hidden size of GSIEA")
        parser.add_argument("--intermediate_size", type=int, default=400, help="the hidden size of GSIEA")
        parser.add_argument("--num_attention_heads", type=int, default=5, help="the number of attention_heads of GSIEA")
        parser.add_argument("--num_hidden_layers", type=int, default=2, help="the number of hidden_layers of GSIEA")
